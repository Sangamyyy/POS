        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    <div class="container-fluid"><span>Sainamaina footwears </span></div>
                </nav>
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-footer p-4">
                                    <form class="text-center" method="post">
                                        <div class="mb-3"><button class="btn btn-primary d-block w-100" type="button" data-bs-target="#purchase" data-bs-toggle="modal">Sales&nbsp;</button></div>
                                    </form>
        ...
        <div class="modal-dialog" role="document">
            <form action="functions/pos-transaction.php" method="post">
                <div class="modal-content">
                   ...
                   <form id="transactionForm" method="POST" action="path/to/your/php-script.php">
    <div class="modal-body">
        <p>Sales Confirmation&nbsp;</p>
        <div class="card">
            <div class="card-body text-center p-4">
                <h6 class="text-uppercase text-muted card-subtitle">TOTAL</h6>
                <h4 class="display-4 fw-bold card-title">Nrs.<?php include 'functions/pos-total.php'; ?></h4>

                <!-- Discount Input with HTML5 min validation -->
                <div class="mb-3">
                    <input class="form-control" type="number" name="discount" id="discount" placeholder="Discount" min="0" step="0.01" required>
                </div>

                <!-- Amount Input with HTML5 min validation -->
                <div class="mb-3">
                    <input class="form-control" type="number" name="amount" id="amount" placeholder="Amount" min="0" step="0.01" required>
                </div>
